...
import org.spring.framework.aop.jdk.JdkProxyFactory;
...
public class LogAop implements BeanPostProcessor {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) {
        ...
        if (bean instanceof IOrderService){
            ...
            return JdkProxyFactory.createProxy(LogAop.class.getClassLoader(), new Class[]{IOrderService.class}, (Object proxy, Method method, Object[] args) -> {
